            ...
            if (Regex.IsMatch(input, "[01234]"))
            {
                switch (input)
                {
                    ...
                    case "2":
                        ...
                        while (true)
                        {
                            _codingSession.StartTime = _helpers.EnterDatePrompt("Please enter date and time (e.g., 12/25/2023 4:30:20 pm)");
                            if (_codingSession.StartTime == default) break;

                            _codingSession.EndTime = _helpers.EnterDatePrompt("Please enter another date and time (e.g., 12/25/2023 4:30:20 pm)");
                    ...
                    case "3":
                        ...
                        while (true)
                        {
                            ...
                            else if (_codingSession.Id < 0) continue;
