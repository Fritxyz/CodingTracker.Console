...
namespace CodingTracker.Library
{
    public static class CodingTrackerCrud
    {
        ...
        internal static void InsertingData(DateTime startTime, DateTime endTime, TimeSpan duration)
        {
            ...
            string date = startTime.ToString("MM/dd/yyyy h:mm:ss tt"),

            _layer.SaveData(
                command,
                new
                {
                    StartTime = startTime.ToString("MM/dd/yyyy h:mm:ss tt"),
                    EndTime = endTime.ToString("MM/dd/yyyy h:mm:ss tt"),
        ...
        #region DeleteData
        internal static void DeleteData(int id)
        {
            string command = @"DELETE FROM coding_session WHERE Id=@id;";
            ...
            _layer.LoadData<CodingSession, dynamic>(command, new { id });
        }
        #endregion
