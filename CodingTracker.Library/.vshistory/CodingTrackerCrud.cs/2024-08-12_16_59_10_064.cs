...
namespace CodingTracker.Library
{
    public static class CodingTrackerCrud
    {
        ...
        public static void ViewData()
        {
            ...
            List<CodingSession> data = _layer.LoadData<CodingSession, dynamic>(command, new { });
            ...
            data.ForEach(data => table.AddRow(data.Id, data.StartTime, data.EndTime, data.Duration));
        }
        #endregion
