...
namespace CodingTracker.Library
{
    internal static class Helpers
    {
        ...
        internal static (DateTime, bool) EnterDatePrompt(string text, DateTime dateTime)
        {
            bool isDateTimeParsed;
            DateTime dateTimeDump = dateTime;
            ...
            do
            {
                ...
                dateTimeDump = parsedDateTime;
                dateTime = dateTimeDump;
